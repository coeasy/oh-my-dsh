/**
 * Plugin manifest validation (install/load-time). Same contract as the
 * usage-analytics plugin, extended with the permissions this plugin needs:
 * settings read/write, session observation, model switching, subagent
 * configuration, and UI mounting.
 */

export const PLUGIN_ID = 'com.my-dsh.model-config'
export const PLUGIN_NAME = 'Model Config'
