/**
 * Browser client bundle for @coeasy/dsh-plugin-marketplace, mirroring the
 ...
 *   3. `external` + `noExternal` keep react/react/jsx-runtime out of the
 *      bundle (the loader module table supplies them); everything else inlines.
 */
import { defineConfig } from 'tsdown'

// MUST equal the loader entry name (= npm package name, = cordis.patch.yml `name`).
const id = '@coeasy/dsh-plugin-marketplace'
